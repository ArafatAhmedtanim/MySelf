  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">Arafat Ahmed</span>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">
            ...
            <p>(+880) 1924-252-248</p>
            <a href="mailto:name@email.com">
                <i>arafatahmedtanimcsedu57@email.com</i>
            </a>-->
          </div>
          ...
          <ul class="list-inline list-social-icons mb-0">
            <li class="list-inline-item">
              <a class="facebook" href="https://www.facebook.com/arafat.a.tanim">
            ...
            <li class="list-inline-item">
              <a class="linkedin" href="https://www.linkedin.com/in/arafat-ahmed-a6047b141/">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
